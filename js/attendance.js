...
function downloadCSV(sessionid, classid, facid) {
    $.ajax({
        ...
        beforeSend: function () {
            // Optional: Add loading indicators or disable buttons here
        },
        success: function (rv) {
            // On success, initiate file download
            let filename = rv.filename;
            if (filename) {
                ...
                alert("No filename received from server.");
            }
        },
